...
"VIM Table Mode for instant table creation. markdown table tpl
...
"A vim plugin to display the indention levels with thin vertical lines 缩进提示线条
...
"omorrow night bright color scheme
Plugin 'axiaoxin/favorite-vim-colorscheme'
"Named Emoji in Vim
Plugin 'junegunn/vim-emoji'
"A fancy start screen for Vim 友好的欢迎界面(最近编辑文件)
Plugin 'mhinz/vim-startify'
"True Sublime Text style multiple selections for Vim 多行编辑
Plugin 'terryma/vim-multiple-cursors'
"Instant Markdown previews from VIM!
Plugin 'suan/vim-instant-markdown'
"quoting/parenthesizing made simple 标签匹配
Plugin 'tpope/vim-surround'
"vim-snipmate default snippets 代码模板补全
Plugin 'honza/vim-snippets'
"lean & mean status/tabline for vim that's light as air 状态栏加强
Plugin 'bling/vim-airline'
"Fuzzy file, buffer, mru, tag, etc finder. 代码补全
Plugin 'kien/ctrlp.vim'
"Vim plugin that displays tags in a window(ctags is needed)
Plugin 'majutsushi/tagbar'
"Vim plugin for intensely orgasmic commenting  快速注释
...
" F2切换行号显示
nnoremap <F3> :set nonu!<CR>:set foldcolumn=0<CR>
